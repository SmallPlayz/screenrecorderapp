...
REM Copyright (c) 2002-2021 TeamDev Ltd. All rights reserved.

set CUSTOM_CLASSES=jxcapturedemo.jar;
set CORE_CLASSES=jniwrap-3.12.jar;jxcapture-3.6.jar;slf4j-api-1.5.8.jar;slf4j-simple-1.5.8.jar;license.jar
